          ...
          IMAGES.map(({id, title, img, demo}) => (
            <div className='embla__slide' key={id}>
              ...
              <div className='absolute top-0 m-4 flex justify-center items-center gap-4'>
                <p className='inline-flex items-center justify-center gap-2 px-3 py-2 space-x-2 text-base text-white transition bg-gray-800 border border-gray-600 rounded-3xl'>{title}</p>

...
function Header () {
    return (
        <header className="fixed top-0 z-10 w-screen h-auto bg-white border-b-2">
            ...
            <div className="h-10 flex items-center justify-center lg:justify-between my-1">
                ...
                <ul className="w-3/4 hidden lg:flex items-center justify-center gap-5 border-x-2 border-gray-400">
                    {
